...
class WordPressCookie
{
	 ...
	 */
/*
 * Removing for now (20200206). deleteCookieValue() allows the removal of the value associated with the cookie, allowing a hash to be reused, temporarily at least.
	public function deleteCookie() {
	    if (isset($this->hashValue)) {
	        ...
	        if (headers_sent ($file, $line)) {
	            $this->logger->warning('Unable to delete cookie, headers already sent, line {line} in {file}', array('line' => $line, 'file' => $file));
	        }
	        else {
