...
class HookTimer
{
     ...
     *
     * @param string[] $hooks The array of hooks to time. Defaults to all hooks.
     ...
     * @param mixed ...$args
     */
    public function allActionHandler(mixed ...$args): void
    {
        $hook = $args[0];
    ...
    private function restartTimerCallback(): void
    {
        if (!empty($this->stack)) {
     ...
     * @return mixed
     */
    public function timerCallback(mixed ...$args): mixed
    {
